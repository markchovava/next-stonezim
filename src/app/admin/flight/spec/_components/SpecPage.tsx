...
import { useSpecStore } from "../_data/store/useSpecStore"
...
const title = 'Cabin Specifications'
        ...
        <>
            <section className="lg:block hidden w-full">
                <div className="w-full text-lg font-semibold border border-gray-300 bg-gray-100 flex items-center justify-start">
                    ...
                    <div className="w-[45%] px-4 py-2 border-r border-gray-300">VALUE</div>
                ...
                {[...Array(5)].map((i, key) => (
                    <div key={key} className="text-gray-700 w-full border border-gray-300 flex items-center justify-start">
                        <div className="w-[45%] px-4 py-2 border-r border-gray-300">Name</div>
                        <div className="w-[45%] px-4 py-2 border-r border-gray-300">The value</div>
                        <div className="w-[10%] px-4 py-2 flex items-center justify-end gap-3">
                            <Link 
                                href='/admin/flight/spec/1' 
                ...
                {[...Array(5)].map((i, key) => (
                    <div key={key} className="bg-white text-gray-700 drop-shadow border border-gray-200 rounded-xl overflow-hidden p-6">
                        <div className="flex items-center justify-end gap-3">
                                <Link href='/admin/flight/spec/1' className="flex items-center justify-center">
                                    <ViewButton />
                                </Link>
                                <DeleteButton onClick={() => {}} />
                            </div>
