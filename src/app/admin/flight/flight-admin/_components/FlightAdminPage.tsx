        ...
        <>
            <section className="lg:block hidden w-full">
                <div className="w-full text-lg font-semibold border border-gray-300 bg-gray-100 flex items-center justify-start">
                    <div className="w-[40%] px-4 py-2 border-r border-gray-300">FROM-TO</div>
                    <div className="w-[20%] px-4 py-2 border-r border-gray-300">AIRLINE</div>
                    <div className="w-[30%] px-4 py-2 border-r border-gray-300">TIME</div>
                ...
                {[...Array(5)].map((i, key) => (
                    <div key={key} className="text-gray-700 w-full border border-gray-300 flex items-center justify-start">
                        <div className="w-[40%] px-4 py-2 border-r border-gray-300">NAME</div>
                        <div className="w-[20%] px-4 py-2 border-r border-gray-300">The description</div>
                        <div className="w-[30%] px-4 py-2 border-r border-gray-300">The time</div>
                        <div className="w-[10%] px-4 py-2 flex items-center justify-end gap-3">
                            <Link 
                                href='/admin/flight/flight-admin/1' 
                ...
                {[...Array(5)].map((i, key) => (
                    <div key={key} className="bg-white text-gray-700 drop-shadow border border-gray-200 rounded-xl overflow-hidden p-6">
                        <div className="flex items-center justify-end gap-3">
                                <Link href='/admin/flight/flight-admin/1' className="flex items-center justify-center">
                                    <ViewButton />
                                </Link>
                                <DeleteButton onClick={() => {}} />
                            </div>
